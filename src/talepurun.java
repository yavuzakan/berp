 ...
 * @author yca
 */
public class talepurun extends javax.swing.JFrame {
       public  Connection c;
 public Statement st;
public  ResultSet rs;
    /**
     * Creates new form talepurun
     */
    public talepurun() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Talep Açılacak Ürün Seç");
        setResizable(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String deneme2 = jTextField4.getText();
        //s102.jTextField3.setText(deneme1);
        //s102.jTextField11.setText(deneme2);
t101.jTextField1.setText(deneme1);
t101.jTextField4.setText(deneme2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(talepurun.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
   ...
   try {
            ...
            st = c.createStatement();
             ...
             String query = "SELECT * FROM urun4 where urun like '%"+ ara +"%' and bolum like '%"+ ara2 +"%' and tur like '%"+ ara3 +"%' ";

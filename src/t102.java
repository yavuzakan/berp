 ...
 * @author yca
 */
public class t102 extends javax.swing.JFrame {
    public  Connection c;
 public Statement st;
public  ResultSet rs;
    /**
     * Creates new form t102
     */
    public t102() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Bekleyen Talepler -T102");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(t102.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
   ...
   try {
            ...
            st = c.createStatement();
             ...
             String query = "SELECT * FROM talep where urun like '%"+ urunara +"%' and giderbolum like '%"+ giderbolumara +"%' and talepacan like '%"+ talepacanara +"%' and durum = 'Talep Açık'";

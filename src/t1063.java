 ...
 * @author user
 */
public class t1063 extends javax.swing.JFrame {
    public  Connection c;
 public Statement st;
public  ResultSet rs;
    /**
     * Creates new form t1063
     */
    public t1063() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        t106.jTextField4.setText(jTextField5.getText() +" - "+jTextField4.getText());
        t106.jTextField8.setText(jTextField4.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(t1063.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
   ...
   try {
            ...
            st = c.createStatement();
             ...
             String query = "SELECT * FROM talep where urun like '%"+ urunara +"%' and giderbolum like '%"+ giderbolumara +"%' and talepacan like '%"+ talepacanara +"%'  ";

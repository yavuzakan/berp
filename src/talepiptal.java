 ...
 * @author yca
 */
public class talepiptal extends javax.swing.JFrame {
    public  Connection c;
 public Statement st;
public  ResultSet rs;
    /**
     * Creates new form talepiptal
     */
    public talepiptal() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        t105.jTextField1.setText(jTextField4.getText());
        t105.jTextField3.setText(jTextField5.getText());
        t105.jTextField4.setText(jTextField6.getText());
        t105.jTextField2.setText(jButton2.getLabel());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(talepiptal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new talepiptal().setVisible(true);
            }
        });
    }

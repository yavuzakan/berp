 ...
 * @author user
 */
public class s101 extends javax.swing.JFrame {
    public  Connection c;
 public Statement st;
public  ResultSet rs;
    /**
     * Creates new form s101
     */
    public s101() {
        initComponents();
...
this.ara();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(s101.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      public void ara()
    {
        ...
        String durumara = jTextField3.getText();
   ...
   try {
            ...
            st = c.createStatement();
             ...
             String query = "SELECT * FROM satislar where musteri like '%"+ musteriara +"%' and urun like '%"+ urunara +"%' and durum like '%"+ durumara +"%'";
